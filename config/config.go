...
func Load() Config {
	...
	config.App = cast.ToString(getOrReturnDefaultValue("PROJECT_NAME", "Block_App"))
	...
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "block_app"))
